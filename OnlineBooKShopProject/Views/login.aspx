             ...
             <div class="col-md-4">
               <form id="form1" runat="server">
                 ...
                 <div class="mt-3">
                        ...
                        <label for="NameU" class="form-label">Enter User Email</label>
                       <input type="email" placeholder="Email of User" autocomplete="off" class="auto-style1" runat="server" id="NameU"/>
                 ...
                 <div class="mt-3">
                    ...
                    <label for="PasswordU" class="form-label">Enter User Password</label>
                    <input type="password" placeholder="Password" autocomplete="off" class="auto-style1" runat="server" id="PasswordU"/>
